...
<head>
    ...
    <title>Jamie Registration</title>
    <!-- Bootstrap core CSS -->
            ...
            <section class="contact-page inner-page">
               <div class="container">
                  <div class="row">
                     ...
                     <!-- WHY? -->
                     <div class="col-md-4">
                        <h4>Registration is free, fast and easy.</h4>
                        <p>Upon registration completion, you can:</p>
                        <hr>
                        <img src="http://placehold.it/400x300" alt="" class="img-fluid">
                        <p></p>
                        <div class="panel">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle collapsed" href="#faq1" aria-expanded="false"><i class="ti-info-alt" aria-hidden="true"></i>Order four favourite dish.</a></h4>
                           </div>
                           <div class="panel-collapse collapse" id="faq1" aria-expanded="false" role="article" style="height: 0px;">
                              <div class="panel-body"> Jamie Food Customer Registration </div>
                           </div>
                        </div>
                        <!-- end:panel -->
                        <div class="panel">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle" href="#faq2" aria-expanded="true"><i class="ti-info-alt" aria-hidden="true"></i>Order four favourite dish.</a></h4>
                           </div>
                           <div class="panel-collapse collapse" id="faq2" aria-expanded="true" role="article">
                              <div class="panel-body"> Register jamie Foods. </div>
                           </div>
                        </div>
                        <!-- end:Panel -->
                        <h4 class="m-t-20">Contact Customer Support</h4>
                        <p> IN need for more help or have a question to ask? please </p>
                     ...
                     <div class="container">
                        <div class="row">
                           ...
                           <div class="col-xs-12 col-sm-4 address color-gray">
                              <h5>Address</h5>
                              <p>Concept design of oline food order and delivery,planned as an online cafeteria</p>
                              <h5>Phone: <a href="tel:+254796083899">254 796 083 899</a></h5>
                           </div>
                           <div class="col-xs-12 col-sm-5 additional-info color-gray">
                              <h5>Addition informations</h5>
                              <p>Join our cafeteria who benefit from having menus on TakeOff</p>
                           </div>
                        </div>
                     </div>
                  </div>
