            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item"><span>3</span><a href="login.php">Order and Pay online</a></li>
                    </ul>
                </div>
            </div>
            <!-- end:Top links -->
                    ...
                    <div class="row top-footer">
                        ...
                        <div class="col-xs-12 col-sm-2 about color-gray">
                            ...
                            <ul>
                                ...
                                <li><a href="login.php">Our Team</a> </li>
                            </ul>
                        </div>
                        <div class="col-xs-12 col-sm-2 how-it-works-links color-gray">
                            <h5>How it Works</h5>
                            <ul>
                                <li><a href="login.php">Enter your location</a> </li>
                                <li><a href="login.php">Choose restaurant</a> </li>
                                <li><a href="login.php">Choose meal</a> </li>
                                <li><a href="login.php">Pay via credit card</a> </li>
                                <li><a href="login.php">Wait for delivery</a> </li>
                            </ul>
                        </div>
                        <div class="col-xs-12 col-sm-2 pages color-gray">
                            <h5>Pages</h5>
                            <ul>
                                <li><a href="login.php">Search results page</a> </li>
                                <li><a href="login.php">User Sing Up Page</a> </li>
                                <li><a href="login.php">Pricing page</a> </li>
                                <li><a href="login.php">Make order</a> </li>
                                <li><a href="login.php">Add to cart</a> </li>
                            </ul>
                        </div>
                        <div class="col-xs-12 col-sm-3 popular-locations color-gray">
                            <h5>Popular locations</h5>
                            <ul>
                            <li><a href="restaurants.php">Soteria</a> </li>
                            <li><a href="restaurants.php">Spu Enterprise Unit</a> </li>
                            <li><a href="restaurants.php">Womens' Centre</a> </li>
                            <li><a href="restaurants.php">Students Centre</a> </li>
                            </ul>
                        </div>
                    </div>
                    <!-- top footer ends -->
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-xs-12 col-sm-3 payment-options color-gray">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="login.php"> <img src="images/paypal.png" alt="Paypal"> </a>
                                        </li>
                                        <li>
                                            <a href="login.php"> <img src="images/mastercard.png" alt="Mastercard"> </a>
                                        </li>
                                        <li>
                                            <a href="login.php"> <img src="images/maestro.png" alt="Maestro"> </a>
                                        </li>
                                        <li>
                                            <a href="login.php"> <img src="images/stripe.png" alt="Stripe"> </a>
                                        </li>
                                        <li>
                                            <a href="login.php"> <img src="images/bitcoin.png" alt="Bitcoin"> </a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-xs-12 col-sm-4 address color-gray">
                                     ...
                                     <h5>Phone: <a href="tel:+254796083899">254 796 083 899</a></h5> </div>
                ...
                <div class="modal-body cart-addon">
                    <div class="food-item white">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-lg-6">
                                ...
                                <!-- end:Logo -->
                                <div class="rest-descr">
                                    <h6><a href="login.php">Sandwich de Alegranza Grande Menü (28 - 30 cm.)</a></h6> </div>
                                <!-- end:Description -->
                            </div>
                            <!-- end:col -->
                    ...
                    <div class="food-item">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-lg-6">
                                ...
                                <!-- end:Logo -->
                                <div class="rest-descr">
                                    <h6><a href="#">Sandwich (28 - 30 cm.)</a></h6> </div>
                                <!-- end:Description -->
                            </div>
                            <!-- end:col -->
                    ...
                    <div class="food-item">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-lg-6">
                                <div class="item-img pull-left">
                                    <a class="restaurant-logo pull-left" href="login.php"><img src="http://placehold.it/70x70" alt="Food logo"></a>
                                </div>
                                <!-- end:Logo -->
                                <div class="rest-descr">
