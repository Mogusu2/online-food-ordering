                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="steps">
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span>3. </span>Delivery or take</h4> </div>
                        <!-- end:Step -->
                    </div>
                    <!-- end:Steps -->
                </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Trending Dishes of the Month</h2>
                    <p class="lead">The easiest way to your best food</p>
                </div>
                <div class="row">
						                       ...
						                       echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
														<div class="food-item-wrap">
															<div class="figure-wrap bg-image" data-image-src="admin/Res_img/dishes/'.$r['img'].'">
																...
																<div class="review pull-right"><a href="#">100 reviews</a> </div>
															</div>
															<div class="content">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Choose a cafeteria</h3>
                                    <p>We"ve got your covered with menus from within the university online.</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    ...
                    <div class="col-xs-12 col-sm-3 popular-locations color-gray">
                        ...
                        <ul>
                            <li><a href="#">Soteria</a> </li>
                            <li><a href="#">Spu Enterprise Unit</a> </li>
                            <li><a href="#">Womens' Centre</a> </li>
                            <li><a href="#">Students Centre</a> </li>
